...
//	                                  state 落 /tmp/wbfusion-login-state.json，stdout 打印授权 URL
...
import (
	...
	auth2 "workbuddy-fusion/internal/auth"
)
...
var stateFile = filepath.Join(os.TempDir(), "wbfusion-login-state.json")
