...
func TestReportChatActivitySendsArrayWithUserID(t *testing.T) {
	...
	if err := c.ReportChatActivity(&auth.Auth{AccessToken: "at", UID: "u-active"}, "wbfusion-123", "req-7"); err != nil {
	...
	if ev["conversationId"] != "wbfusion-123" {
		t.Errorf("conversationId=%v want wbfusion-123", ev["conversationId"])
	}
