...
// TestEffortListingStaticFallback 远端无档位 → 落到 CN 静态兜底表（取静态兜底档位）。
...
// TestEffortListingRealmSplit 场景核心：同模型 deepseek-v4.1-flash 在两个 realm 档位刻意不同。
