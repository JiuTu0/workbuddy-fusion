...
// global（历史实测 /v2/report 在 workbuddy.ai code=0 OK）。
//
...
// 历史实测 workbuddy.ai /v2/report code=0 OK）；travel 仍只服务 CN（global 跳过）。
...
// （实测国际版 /v2/report 在 workbuddy.ai 上 code=0 OK）。fake upstream 断言
